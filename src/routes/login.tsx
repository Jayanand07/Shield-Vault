...
export const Route = createFileRoute("/login")({
  head: () => ({
    meta: [{ title: "Sign in — ShieldVault" }, { name: "description", content: "Sign in to your ShieldVault account." }],
  }),
  component: LoginPage,
});
    ...
    <div className="min-h-screen grid place-items-center px-4 relative overflow-hidden">
      ...
      >
        ...
        <div className="glass-strong rounded-2xl p-8">
          ...
          <p className="text-sm text-muted-foreground mt-1">Sign in to your encrypted vault.</p>
